...
function getSubjects() {
    ...
    let result = $.ajax({
        url: `https://jgmil-lesson-planner.herokuapp.com/subjects/` + user_id,
            dataType: "json",
            type: "GET"
        })
...
function getUnits(subjectId) {
    let user_id = $("#loggedInUser").val();
    let result = $.ajax({
        url: `https://jgmil-lesson-planner.herokuapp.com/units/` + user_id,
            dataType: "json",
            type: "GET"
        })
        /* if the call is successful (status 200 OK) show results */
...
function getLessons() {
    ...
    const result = $.ajax({
        url: `https://jgmil-lesson-planner.herokuapp.com/lessons/` + user_id,
            dataType: "json",
            type: "GET"
        })
        /* if the call is successful (status 200 OK) show results */
...
function genereateLessonDetail(lessonId) {
    ...
    let result = $.ajax({
        url: "https://jgmil-lesson-planner.herokuapp.com/lesson/" + lessonId,
            dataType: "json",
            type: "GET"
        })
        /* if the call is successful (status 200 OK) show results */
...
function deleteAssociatedUnits(subjectId) {
    $.ajax({
            type: "DELETE",
            url: "https://jgmil-lesson-planner.herokuapp.com/units/" + subjectId,
            dataType: "json",
...
function deleteAssociatedLessons(unitId) {
    $.ajax({
            type: "DELETE",
            url: "https://jgmil-lesson-planner.herokuapp.com/lessons/" + unitId,
            dataType: "json",
            contentType: "application/json"
        })
        .done(function (result) {
...
$(document).on("submit", "#create-account-form", function (event) {
    ...
    if (pw !== confirmPw) {
        ...
        $.ajax({
                type: "POST",
                url: "https://jgmil-lesson-planner.herokuapp.com/users/create",
                dataType: "json",
...
$(document).on("submit", "#log-in", function (event) {
    ...
    if ((!uname) || (uname.length < 1) || (uname.indexOf(" ") > 0)) {
        ...
        $.ajax({
                type: "POST",
            url: "https://jgmil-lesson-planner.herokuapp.com/users/signin",
                dataType: "json",
            ...
            .done(function (result) {
                ...
                $("#log-in-link").hide();
                $("#loggedInUser").val(result._id);
                $(".user-banner").html(`Welcome, ${result.name}!`);
                getSubjects();
            })
            .fail(function (jqXHR, error, errorThrown) {
                console.log(jqXHR);
...
$(document).on("submit", ".update-subject", function (event) {
    ...
    $.ajax({
            type: "PUT",
        url: "https://jgmil-lesson-planner.herokuapp.com/subject/" + subject_id,
            dataType: "json",
...
$(document).on("submit", ".update-unit", function (event) {
    ...
    $.ajax({
            type: "PUT",
            url: "https://jgmil-lesson-planner.herokuapp.com/unit/" + unit_id,
            dataType: "json",
...
$(document).on("submit", "#update-lesson", function (event) {
    ...
    $.ajax({
            type: "PUT",
        url: "https://jgmil-lesson-planner.herokuapp.com/lesson/" + lesson_id,
            dataType: "json",
...
$(document).on("submit", "#new-subject", function (event) {
    ...
    $.ajax({
            type: "POST",
        url: "https://jgmil-lesson-planner.herokuapp.com/subject/create",
            dataType: "json",
...
$(document).on("submit", "#new-unit", function (event) {
    ...
    $.ajax({
            type: "POST",
        url: "https://jgmil-lesson-planner.herokuapp.com/unit/create",
            dataType: "json",
...
$(document).on("submit", "#new-lesson", function (event) {
    ...
    $.ajax({
            type: "POST",
        url: "https://jgmil-lesson-planner.herokuapp.com/lesson/create",
            dataType: "json",
    ...
    $(".create").html(
        `<fieldset>
            ...
            <form id="new-unit">
                ...
                <select class="subject-select" name="subject-name" aria-label="subject-name"></select>
                <button type="submit"">Create</button>
    ...
    $(".create").html(
        `<fieldset>
            ...
            <form id="new-lesson">
                ...
                <select class="subject-select" name="subject-name" aria-label="subject-name"></select>
                <select class="unit-select" name="unit-name" aria-label="unit-name"></select>
                <div class="day-container">
                    <label for="day">Day: </label>
